...
add_image_size('mini', 110, 170, true );
add_image_size('acciones', 390, 755, true );
add_image_size('sportman', 590, 900, true );
}
/* 
...
add_action('init', 'deportistas_register');
function deportistas_register() {
    $args = array(
        'label' => 'Team',
        'singular_label' => 'Deportista',
        'public' => true,
		'menu_position' => 5, 
        '_builtin' => false,
		...
		'has_archive' => false,
        'hierarchical' => false,
        'rewrite' => array( 'slug' => 'team-chile'),
        'supports' => array('title', 'editor' , 'excerpt' , 'thumbnail' )
    );
    register_post_type('deportista', $args);
    flush_rewrite_rules();
}
